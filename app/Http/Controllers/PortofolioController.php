...
class PortofolioController extends Controller
{
  ...
  function store(Request $req){
    try {
      $post = array_merge($req->only(['title', 'description', 'category_id']), [
  ...
  function update(Request $req){
    try {
      ...
      return redirect(url('portofolio'))->with('success', 'Porotofolio berhasil diperbarui!');
  ...
  function delete(Request $req){
    try {
      ...
      return redirect(url('portofolio'))->with('success', 'Portofolio berhasil dihapus!');
