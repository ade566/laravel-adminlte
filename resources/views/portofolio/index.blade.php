<x-layout title="Portofolio">

  <div class="card">
    <div class="card-header border-0 mb-1">
      <a href="{{url('portofolio/add')}}" class="btn btn-primary">
        Tambah
      </a>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <a href="{{url('portofolio/edit/'.$item->id)}}" class="btn btn-warning btn-sm mr-2">Edit</a>

                    <form action="{{url('portofolio/delete')}}" method="post">
                      @csrf
