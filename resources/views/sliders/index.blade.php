<x-layout title="Slider">

  <div class="card">
    <div class="card-header border-0 mb-1">
      <a href="{{url('sliders/add')}}" class="btn btn-primary">
        Tambah
      </a>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <a href="{{url('sliders/edit/'.$item->id)}}" class="btn btn-warning btn-sm mr-2">Edit</a>

                    <form action="{{url('sliders/delete')}}" method="post">
                      @csrf
