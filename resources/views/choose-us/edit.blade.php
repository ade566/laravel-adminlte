<x-layout title="{{$title}}">
  ...
  <div class="card card-primary">
    ...
    <form method="post" action="{{url('choose-us/update')}}" enctype="multipart/form-data">
      @csrf
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="overview" id="overview_input" placeholder="Masukan overview" value="{{$item->overview}}" />
        </div>
        <div class="form-group">
          <label for="file_input">Foto Keunggulan Kami</label>
