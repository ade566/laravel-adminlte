<x-layout title="Partner">

  <div class="card">
    <div class="card-header border-0 mb-1">
    <a href="{{url('partner/add')}}" class="btn btn-primary">
      Tambah
    </a>
    ...
    <div class="table-responsive">
      ...
      <tbody>
        ...
        <tr>
         ...
         <td>
          <a href="{{url('partner/edit/'.$item->id)}}" class="btn btn-warning btn-sm mr-2">Edit</a>
          <form action="{{url('partner/delete')}}" method="post">
            @csrf
